...
def main():
    ...
    with fmu.instantiate(
        ...
        logger.info(fmu_instance.step(input_values={"int_setpoint": 3, "real_setpoint": 1., "bool_setpoint": False}))
        logger.info(fmu_instance.step(input_values={"int_setpoint": 4, "real_setpoint": 1., "bool_setpoint": False}))
